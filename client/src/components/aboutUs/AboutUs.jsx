  ...
  return (
    <div  className = 'about'>
      ...
      Jose A.Carballo Rojas
       ...
       <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/facundo-duartes-dev/' target='_blank'>
         Facundo Duartes
        ...
        <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/lucas-di-caro' target='_blank'>
         Lucas Di Caro
        ...
        <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/francomcruz/' target='_blank'>
         Franco Cruz
        ...
        <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/juan-kaunitz/' target='_blank'>
         Juan Kaunitz
        ...
        <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/kevin-luciano-favre-jarupkin/' target='_blank'>
        ...
        <div className={classes.listItem}>
       <Link to='https://www.linkedin.com/in/octavio-bissutti/' target='_blank'>
        Octavio Bissutti
